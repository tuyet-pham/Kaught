...
class EntryMenu(tk.Frame):
    def __init__(self, master):
        ...
        self['bg'] = master['bg']
        KLabel(self, text="Stock Predictor").pack(fill=BOTH, expand=TRUE)
        KButtonDark(self, width=20, text="Start Project", bg='MediumSlateBlue', fg='snow', height=2, command=lambda: master.switch_frame(MainMenu)).pack(side=BOTTOM, pady=50, padx=50, anchor='se')
...
class MainMenu(tk.Frame):
    def __init__(self, master):
        tk.Frame.__init__(self, master)
        self['bg'] = master['bg']
        KLabel(self, text="Stock Predictor News\nand Update").pack(side=TOP, fill="x", pady=10)
        KButtonDark(self, width=20, text="Close Project", bg='MediumSlateBlue', fg='snow', height=2, command=lambda: master.switch_frame(EntryMenu)).pack(side=TOP, pady=10)
...
class StockPicker(Frame):
    ...
    def setdefault(self):
        ...
        self.browsebut1 = KButtonDark(self, width=15, text="Browse", bg='MediumSlateBlue', fg='snow', height=1, command=lambda: self.chosestock(1))
        ...
        self.browsebut2 = KButtonDark(self, width=15, text="Browse", bg='MediumSlateBlue', fg='snow', height=1, command=lambda: self.chosestock(2))
        ...
        self.browsebut3 = KButtonDark(self, width=15, text="Browse", bg='MediumSlateBlue', fg='snow', height=1, command=lambda: self.chosestock(3))
        ...
        self.browsebut4 = KButtonDark(self, width=15, text="Browse", bg='MediumSlateBlue', fg='snow', height=1, command=lambda: self.chosestock(4))
...
class Adjustments(tk.Frame):
    def __init__(self, master):
        tk.Frame.__init__(self, master)
        self['bg'] = master['bg']
        KLabel(self, text="Adjustments").pack(side=TOP, fill="x", pady=10)
...
class MakeTree(tk.Frame):
    def __init__(self, master):
        tk.Frame.__init__(self, master)
        self['bg'] = master['bg']
        KLabel(self, text="Make Tree PNG").pack(side=TOP, fill="x", pady=10)
...
class Tables(tk.Frame):
    def __init__(self, master):
        tk.Frame.__init__(self, master)
        self['bg'] = master['bg']
        KLabel(self, text="Tables").pack(side=TOP, fill="x", pady=10)
